...
Route::resource('surat_keluar_barangs', 'SuratKeluarBarangAPIController');

Route::resource('surat_keluar_barang_lines', 'SuratKeluarBarangLineAPIController');

Route::resource('steps', 'StepAPIController');

Route::resource('articles', 'ArticleAPIController');

Route::resource('article_lines', 'ArticleLineAPIController');

Route::resource('surat_perintah_kerjas', 'SuratPerintahKerjaAPIController');

Route::resource('operator_jahits', 'OperatorJahitAPIController');

Route::resource('operator_buang_benangs', 'OperatorBuangBenangAPIController');

Route::resource('operator_gosoks', 'OperatorGosokAPIController');