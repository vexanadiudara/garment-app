...
<!-- Product Departement Id Field -->
<div class="form-group col-sm-6">
    {!! Form::label('product_departement_id', 'Product Departement Id:') !!}
    {!! Form::text('product_departement_id', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('suratKeluarBarangs.index') !!}" class="btn btn-default">Cancel</a>
</div>
