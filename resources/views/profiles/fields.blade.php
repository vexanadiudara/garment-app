...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('cabang_id', $cabang->pluck('nama', 'id')->toArray(), null, ['class' => 'form-control select2']) !!}
</div>

<div class="form-group col-sm-6">
    {!! Form::label('jabatan_id', 'Jabatan:') !!}
    {!! Form::select('jabatan_id', $jabatan->pluck('nama', 'id')->toArray(), null, ['class' => 'form-control select2']) !!}
</div>
