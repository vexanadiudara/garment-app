...
namespace Webcore\FileManager;

use Illuminate\Support\ServiceProvider;
use Webcore\FileManager\Helpers\FileManagerHelper;
...
class FileManagerServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        $this->publishes([
            __DIR__.'/Views/default_views' => base_path('resources/views/vendor/webcore/filemanager'),
        ], 'views');
    ...
    public function register()
    {
        ...
        $this->app->singleton('filemanager', 'Webcore\FileManager\Helpers\FileManagerHelper');

        $this->app->make('Webcore\FileManager\Controllers\FileManagerController');
//        \Route::group(['prefix' => 'assets', 'middleware' => 'auth'], function() {
//            \Route::controller('/', 'Webcore\FileManager\Controllers\FileManagerController');
//        });
